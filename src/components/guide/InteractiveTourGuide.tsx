...
const TOUR_STEPS: TourStep[] = [
  {
    id: 'security',
    badge: {
      hi: 'राष्ट्रीय सुरक्षा प्रोटोकॉल • Z+ ब्लैक कैट सुरक्षा',
      en: 'National Security Protocol • Z+ Black Cat Security'
    },
    title: {
      hi: 'एनएसजी कमांडो साइबर शील्ड एवं ऑटो-लॉगआउट',
      en: 'NSG Commando Cyber Shield & Inactivity Auto-Logout',
      bn: 'এনএসজি কমান্ডো সাইবার সুরক্ষা এবং অটো-লগআউট',
      te: 'NSG కమాండో సైబర్ షీల్డ్ & ఆటో-లాగౌట్',
      mr: 'एनएसजी कमांडो सायबर शील्ड आणि ऑटो-लॉगआउट',
      ta: 'NSG கமாண்டோ சைபர் பாதுகாப்பு மற்றும் தானியங்கி வெளியேற்றம்',
      gu: 'NSG કમાન્ડો સાયબર શિલ્ડ અને ઓટો-લૉગઆઉટ',
      sat: 'NSG ᱠᱚᱢᱟᱱᱰᱳ ᱥᱟᱭᱵᱚᱨ ᱨᱩᱠᱷᱤᱭᱟᱹ ᱟᱨ ᱟᱹᱯᱱᱟᱹᱛ ᱞᱚᱜᱽ-ᱟᱣᱩᱴ',
      or: 'NSG କମାଣ୍ଡୋ ସାଇବର ସୁରକ୍ଷା ଓ ଅଟୋ-ଲଗଆଉଟ୍',
      pa: 'NSG ਕਮਾਂਡੋ ਸਾਈਬਰ ਸੁਰੱਖਿਆ ਅਤੇ ਆਟੋ-ਲੌਗਆਉਟ'
    },
    desc: {
      hi: 'यह मंत्रालय का अत्यंत सुरक्षित पोर्टल है (0.000001% डेटा लीक सुरक्षा)। हेडर में आपका क्रिप्टोग्राफिक NSG टोकन और 15 मिनट का टाइमर सक्रिय रहता है। कार्य समाप्त होने पर "सुरक्षित लॉगआउट" बटन दबाएं।',
      en: 'This is a restricted Ministry portal with zero-leakage security (< 0.000001% risk). The top bar displays your cryptographic NSG Level-4 token and a 15-minute countdown clock. Click "सुरक्षित लॉगआउट" anytime to wipe your session.',
      bn: 'এটি একটি সুরক্ষিত সরকারি পোর্টাল (০.০০০১% ডেটা ফাঁসের সম্ভাবনা)। হেডারে ১৫ মিনিটের সেশন টাইমার ও ক্রিপ্টোগ্রাফিক টোকেন সক্রিয় থাকে।',
      te: 'ఇది అత్యంత సురక్షితమైన మంత్రిత్వ శాఖ పోర్టల్. హెడర్‌లో క్రిప్టోగ్రాఫిక్ టోకెన్ మరియు 15 నిమిషాల టైమర్ కనిపిస్తుంది.',
      mr: 'हे मंत्रालयाचे अतिसुरक्षित पोर्टल आहे (0.000001% डेटा गळती धोका). हेडरमध्ये क्रिप्टोग्राफिक टोकन आणि 15 मिनिटांचा टायमर कार्यरत असतो.',
      ta: 'இது மிகவும் பாதுகாக்கப்பட்ட அமைச்சக தளம். 15 நிமிட அமர்வு நேரம் மற்றும் பாதுகாப்பு டோக்கன் இதில் செயல்படுகிறது.',
      gu: 'આ મંત્રાલયનું સુરક્ષિત પોર્ટલ છે. હેડરમાં ક્રિપ્ટોગ્રાફિક ટોકન અને ૧૫ મિનિટનો ટાઈમર સક્રિય રહે છે.',
      sat: 'ᱱᱚᱣᱟ ᱫᱚ ᱟᱹᱰᱤ ᱨᱩᱠᱷᱤᱭᱟᱹ ᱢᱚᱱᱛᱨᱟᱞᱚᱭ ᱯᱚᱨᱴᱟᱞ ᱠᱟᱱᱟ᱾ ᱪᱮᱛᱟᱱ ᱨᱮ 15 ᱴᱤᱲᱤᱡ ᱨᱮᱭᱟᱜ ᱴᱟᱭᱢᱟᱨ ᱛᱟᱦᱮᱸᱱᱟ᱾',
      or: 'ଏହା ଏକ ସୁରକ୍ଷିତ ସରକାରୀ ପୋର୍ଟାଲ। ହେଡରରେ ୧୫ ମିନିଟ୍ ର ସେସନ୍ ଟାଇମର୍ ସକ୍ରିୟ ଥାଏ।',
      pa: 'ਇਹ ਮੰਤਰਾਲੇ ਦਾ ਅਤਿ-ਸੁਰੱਖਿਅਤ ਪੋਰਟਲ ਹੈ। ਹੈਡਰ ਵਿੱਚ ਕ੍ਰਿਪਟੋਗ੍ਰਾਫਿਕ ਟੋਕਨ ਅਤੇ 15 ਮਿੰਟ ਦਾ ਟਾਈਮਰ ਕਿਰਿਆਸ਼ੀਲ ਰਹਿੰਦਾ ਹੈ।'
    },
    targetComponent: 'Header Security Chip & Logout Button',
    buttonLabel: {
      hi: '🔒 [NSG Level-4 Token] • [सुरक्षित लॉगआउट]',
      en: '🔒 [NSG Level-4 Token] • [Secure Logout]'
    },
      ...
      <div className="max-w-xl w-full bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col relative animate-in zoom-in-95 duration-200">
        ...
        <div className="p-6 sm:p-7 space-y-5">
          ...
          <div className="flex items-center gap-2 text-[11px] text-emerald-800 bg-emerald-50 px-3 py-2 rounded-xl border border-emerald-200">
            ...
            <span>0.000001% Zero-Leakage Architecture • Digital India Certified</span>
          </div>
